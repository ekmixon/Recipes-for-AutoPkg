...
"""See docstring for ChefService class."""
...
class ChefService(Processor):
    ...
    input_variables = {
        ...
        "service_supports": {
            "required": True,
            "description": (
                "A list of properties that controls how the "
                "chef-client is to attempt to manage a "
                "service: :restart, :reload, :status."
            ),
        },
        "service_only_if": {"required": False, "description": "only_if guard phrase."},
        "service_not_if": {"required": False, "description": "not_if guard phrase."},
        "service_extra_indentation": {
            "required": False,
            "description": "Indent this block. Defaults to empty.",
        },
        "service_indentation_end": {
            "required": False,
